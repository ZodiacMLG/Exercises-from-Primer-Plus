...
//  Suppose a = (A,Bi) and c = (C,Di). Here are some complex operations:
...
//  Standard C++ already has complex support-rather
//  more extensive than in this examplein a complex header file,
