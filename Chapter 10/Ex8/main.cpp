...
//  Design a List class to represent this abstract type.
//  You should provide a list.h header file with the class declaration
//  and a list.epp file with the class method implementations.
...
//  where Item is the type for items in the list.
...
int main() {
	...
	std::cout << items.checkisEmpty() << std::endl;
	std::cout << items.checkisFull() << std::endl;
	items.showElements();
